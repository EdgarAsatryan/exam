  ...
  return (
    <div className='w-full h-auto pb-16 bg-black flex items-center justify-center'>
      <div className='w-[80%] h-full flex flex-col gap-9'>
        ...
        <div><iframe className='w-[40%] h-[300px]' src="https://www.google.com/maps/d/embed?mid=1epcK_3XhnFZfFn1KqFhhWr3sQO8&ehbc=2E312F" width="640" height="480"></iframe></div>
        </div>
        </div>
        <div>
        <form className='flex flex-col gap-5'>
          ...
          <div></div>
          <textarea className='p-2 text-xl w-[100%] h-[200px]' name="" id="" cols="30" rows="10"></textarea>
          <button className='w-[120px] h-[40px] bg-[#8355e4] p-2 flex justify-center items-center rounded-3xl self-center  text-white font-semibold'>Submit</button>
        </form>
        </div>
        </div>
      </div>
